                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Transfer admin privileges to a new wallet (7-day
                      acceptance window)
                    </p>
                  </div>
                    ...
                    isAdmin && (
                      <div className="space-y-4">
                        ...
                        <Button
                          ...
                          disabled={
                            !newAdminAddress || txLoading || isRefreshing
                          }
                        >
                          Initiate Transfer
                        </Button>
                        ...
                        >
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                This will start a 7-day transfer process. The
                                new admin must accept within this timeframe. You
                                can cancel at any time before acceptance.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                      ...
                      >
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              You are about to become the platform
                              administrator. This will give you full control
                              over the platform. This action cannot be undone.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            <AlertDialogCancel>Cancel</AlertDialogCancel>
                  ...
                  <div className="grid gap-3 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-theme-text">
                        $
                        {(
                          config.maxDonationAmount / 1_000_000
                        ).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
